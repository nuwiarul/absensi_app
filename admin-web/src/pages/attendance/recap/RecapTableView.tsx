                    ...
                    <tr key={r.session_id} className="border-t">
                      <td className="p-2 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          <span>{fmtDateId(r.work_date)}</span>
                          {r.calendar_day_type === "HALF_DAY" ? (
                              <Badge variant="outline" className="text-[10px] px-2 py-0" title="Half Day">
                                Half Day
                              </Badge>
                          ) : null}
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {r.has_duty_schedule ? (
                              <button
                                  type="button"
                                  className="inline-flex"
                                  title={r.duty_schedule_titles ? `Lihat detail duty: ${r.duty_schedule_titles}` : "Lihat detail duty"}
                                  onClick={() => onPickDay?.(r.work_date)}
                              >
                                <Badge variant="outline" className="cursor-pointer text-[10px] px-2 py-0">
                                  Duty
                                </Badge>
                              </button>
                          ) : null}
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          ...
                          {r.has_duty_schedule ? (
                              <Badge
                                  variant="outline"
                                  title={r.duty_schedule_titles ? `Duty Schedule: ${r.duty_schedule_titles}` : "Duty Schedule"}
