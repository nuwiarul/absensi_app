        ...
        <DialogContent className="max-w-3xl">
          ...
          {!dayYmd ? null : (
              <div className="space-y-4">
                ...
                {selectedDayRow?.has_duty_schedule ? (
                    <div className="rounded-md border p-3">
                      <div className="flex items-center gap-2">
                        <Badge variant="outline">Duty Schedule</Badge>
                        <div className="text-xs text-muted-foreground">Jadwal dinas / duty schedule pada tanggal ini</div>
                      </div>
                      {selectedDayRow?.duty_schedule_titles ? (
                          <div className="mt-2 text-sm">
                            <span className="text-muted-foreground">Keterangan:</span> {selectedDayRow.duty_schedule_titles}
                          </div>
                      ) : null}
                    </div>
                ) : null}
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <div className="rounded-md border p-3">
                    ...
                    {(() => {
                      // Jangan tampilkan perhitungan telat untuk duty schedule.
                      if (selectedDayRow?.has_duty_schedule) return null
